...
export const HomePage: React.FC<HomePageProps> = ({ startAnimations = true }) => {
  ...
  return (
    <div className="pb-16">
      {/* Mobile WhatsApp Banner - Above video */}
      <div className="md:hidden mb-6 px-4">
        <a
          href="https://wa.me/919980761856?text=Hi!%20I%20would%20like%20to%20order%20from%20Sakkat%20Soppu."
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 px-3 py-2.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg transition-all shadow-md"
        >
          ...
          <span className="font-semibold text-xs">Call or text on WhatsApp</span>
        </a>
      </div>
