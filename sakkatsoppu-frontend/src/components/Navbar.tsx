      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16 gap-2">
          ...
          <div className="md:hidden flex items-center gap-1">
            {/* Mobile WhatsApp - Icon with text */}
            <a
              href="https://wa.me/919980761856?text=Hi!%20I%20would%20like%20to%20order%20from%20Sakkat%20Soppu."
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 px-1.5 py-1 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg transition-colors border border-green-200 text-[10px]"
            >
